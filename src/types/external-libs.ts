import { THREE } from "./core-types";

// PhysX type stubs (mock types - plugin doesn't use actual PhysX)
...
// THREE.js Extensions (optional PhysX integration - not used in mock physics)
