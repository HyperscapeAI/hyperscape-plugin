...
import { Vector3, Position, ContentInstance } from "./core-types";

// Re-export CharacterControllerOptions from core-types to avoid duplication
export type { CharacterControllerOptions } from "./core-types";
